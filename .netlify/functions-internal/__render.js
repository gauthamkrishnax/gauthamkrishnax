...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n\n<head>\n	<meta charset="utf-8" />\n	<link rel="icon" href="/favicon.png" />\n	<meta name="viewport" content="width=device-width, initial-scale=1" />\n	<link rel="preload" href="/fonts/harmony.woff2" as="font" crossorigin />\n	<link rel="preload" href="/fonts/tenorsans.woff2" as="font" crossorigin />\n	' + head + '\n</head>\n\n<body>\n	<div id="svelte">' + body + "</div>\n</body>\n\n</html>";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-5af27bee.js",
      css: [assets + "/_app/assets/start-c446e5f0.css"],
      js: [assets + "/_app/start-5af27bee.js", assets + "/_app/chunks/vendor-3c17d4b5.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 6604, "type": "image/png" }, { "file": "fonts/harmony.woff", "size": 28856, "type": "font/woff" }, { "file": "fonts/harmony.woff2", "size": 22228, "type": "font/woff2" }, { "file": "fonts/tenorsans.woff", "size": 23496, "type": "font/woff" }, { "file": "fonts/tenorsans.woff2", "size": 18532, "type": "font/woff2" }, { "file": "noise.png", "size": 38460, "type": "image/png" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-d24f6a2f.js", "css": ["assets/pages/__layout.svelte-2943a540.css"], "js": ["pages/__layout.svelte-d24f6a2f.js", "chunks/vendor-3c17d4b5.js"], "styles": [] }, "src/routes/__error.svelte": { "entry": "pages/__error.svelte-f5032a1f.js", "css": ["assets/pages/__error.svelte-f085b6ea.css", "assets/Footer.svelte_svelte&type=style&lang-778f740b.css", "assets/flower-49f67a69.css"], "js": ["pages/__error.svelte-f5032a1f.js", "chunks/vendor-3c17d4b5.js", "chunks/flower-241b9df5.js", "chunks/Footer-793e1102.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-06847cac.js", "css": ["assets/pages/index.svelte-ab3dacd6.css", "assets/Footer.svelte_svelte&type=style&lang-778f740b.css", "assets/flower-49f67a69.css", "assets/Loader-1ab7113f.css"], "js": ["pages/index.svelte-06847cac.js", "chunks/vendor-3c17d4b5.js", "chunks/flower-241b9df5.js", "chunks/Loader-4e3cf07e.js", "chunks/Footer-793e1102.js", "chunks/ProjectDetails-07d13ec0.js"], "styles": [] }, "src/routes/projects/kanakoot.svelte": { "entry": "pages/projects/kanakoot.svelte-d16e85fa.js", "css": ["assets/pages/projects/kanakoot.svelte-af091a5f.css", "assets/Footer.svelte_svelte&type=style&lang-778f740b.css", "assets/Loader-1ab7113f.css"], "js": ["pages/projects/kanakoot.svelte-d16e85fa.js", "chunks/vendor-3c17d4b5.js", "chunks/Loader-4e3cf07e.js", "chunks/Footer-793e1102.js", "chunks/ProjectDetails-07d13ec0.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-f9c23dcb.js", "css": ["assets/pages/contact.svelte-f2ce5971.css", "assets/Footer.svelte_svelte&type=style&lang-778f740b.css", "assets/flower-49f67a69.css"], "js": ["pages/contact.svelte-f9c23dcb.js", "chunks/vendor-3c17d4b5.js", "chunks/flower-241b9df5.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-a0acd8bf.js", "css": ["assets/pages/about.svelte-b20967b9.css", "assets/Footer.svelte_svelte&type=style&lang-778f740b.css", "assets/Loader-1ab7113f.css"], "js": ["pages/about.svelte-a0acd8bf.js", "chunks/vendor-3c17d4b5.js", "chunks/Loader-4e3cf07e.js", "chunks/Footer-793e1102.js"], "styles": [] } };
...
var ProjectPreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${escape(project.name) + " top svelte-1ldo2iw"}"${add_attribute("this", container, 0)}><div class="${"container svelte-1ldo2iw"}"><h2 class="${"projectTitle svelte-1ldo2iw"}">${escape(project.name)}</h2>
			<div class="${"content svelte-1ldo2iw"}"><div class="${"projectNo svelte-1ldo2iw"}"><h3 class="${"svelte-1ldo2iw"}">PROJECT-${escape(no)}</h3></div>
				<section class="${"svelte-1ldo2iw"}"><article class="${"arti svelte-1ldo2iw"}"><h5 class="${"svelte-1ldo2iw"}">About</h5>
						<p class="${"svelte-1ldo2iw"}">${escape(project.about)}</p></article>
					<article class="${"arti svelte-1ldo2iw"}"><h5 class="${"svelte-1ldo2iw"}">Role</h5>
						<ul>${each(project.role, (role) => `<li class="${"svelte-1ldo2iw"}">${escape(role)}</li>`)}</ul></article>
					<article class="${"links arti svelte-1ldo2iw"}"><h4 class="${"svelte-1ldo2iw"}"><a${add_attribute("href", project.route, 0)} class="${"svelte-1ldo2iw"}"><span class="${"svelte-1ldo2iw"}">Learn more<div style="display: contents; --left-margin:${".5em"};">${validate_component(Arrow, "Arrow").$$render($$result, { direction: "right" }, {}, {})}</div></span></a></h4>
						<p class="${"svelte-1ldo2iw"}"><a${add_attribute("href", project.link, 0)} class="${"svelte-1ldo2iw"}"><span class="${"svelte-1ldo2iw"}">Visit Site<div style="display: contents; --left-margin:${".5em"}; --width-size:${"15px"};">${validate_component(Arrow, "Arrow").$$render($$result, { direction: "right" }, {}, {})}</div></span></a></p></article>
					<article class="${"progress arti svelte-1ldo2iw"}"><h5 class="${"svelte-1ldo2iw"}">Progress</h5>
						<p class="${"svelte-1ldo2iw"}">${escape(project.progress)}</p></article></section></div></div>
		<div class="${"previewContainer svelte-1ldo2iw"}"><img class="${"preview2 img svelte-1ldo2iw"}"${add_attribute("src", project.previewImage[1], 0)} alt="${"Screenshot"}">
			<img class="${"preview1 img svelte-1ldo2iw"}"${add_attribute("src", project.previewImage[0], 0)} alt="${"Screenshot"}"></div>
	</section>`;
});
var css$5 = {
  code: 'main.svelte-1bd78nq.svelte-1bd78nq{display:grid;grid-template-columns:1.5fr 1fr;margin-top:12vh;height:100vh}@media only screen and (max-width: 1280px){main.svelte-1bd78nq.svelte-1bd78nq{margin-top:100px;height:100vh;grid-template-columns:1fr;grid-template-rows:1.5fr 1fr}}@media only screen and (max-width: 720px){main.svelte-1bd78nq.svelte-1bd78nq{margin-top:30px}}@media only screen and (max-height: 480px){main.svelte-1bd78nq.svelte-1bd78nq{margin-top:30px}}main.svelte-1bd78nq .hero.svelte-1bd78nq{margin:8vh 20px 0 120px;max-width:1000px}main.svelte-1bd78nq .hero div.svelte-1bd78nq{margin-top:10px;display:flex;align-items:center;font-size:24px;color:#505050;letter-spacing:0.15em}@media only screen and (max-width: 1280px){main.svelte-1bd78nq .hero div.svelte-1bd78nq{margin-top:10px;font-size:18px}}@media only screen and (max-width: 720px){main.svelte-1bd78nq .hero div.svelte-1bd78nq{margin-top:5px;font-size:14px}}@media only screen and (max-height: 480px){main.svelte-1bd78nq .hero div.svelte-1bd78nq{margin-top:5px;font-size:14px}}@media only screen and (max-width: 1280px){main.svelte-1bd78nq .hero.svelte-1bd78nq{max-width:500px;margin:100px 20px 20px 64px}}@media only screen and (max-width: 720px){main.svelte-1bd78nq .hero.svelte-1bd78nq{max-width:250px;margin:100px 10px 10px 40px}}@media only screen and (max-height: 480px){main.svelte-1bd78nq .hero.svelte-1bd78nq{max-width:250px;margin:100px 10px 10px 40px}}main.svelte-1bd78nq .hero-illu.svelte-1bd78nq{position:absolute;width:35%;top:0;right:0;bottom:0;display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr 2fr 2fr}@media only screen and (max-width: 1280px){main.svelte-1bd78nq .hero-illu .changePdivOne.svelte-1bd78nq{grid-column:2/3;grid-row:2/3}}@media only screen and (max-width: 1280px){main.svelte-1bd78nq .hero-illu .changePdivTwo.svelte-1bd78nq{grid-column:3/4;grid-row:1/2}}@media only screen and (max-width: 1280px){main.svelte-1bd78nq .hero-illu.svelte-1bd78nq{opacity:30%;top:auto;bottom:0;right:0;width:100%;height:40%;grid-template-columns:1fr 1fr 1fr;grid-template-rows:1fr 1fr}}main.svelte-1bd78nq .hero-illu div.svelte-1bd78nq{border-top:1px solid #d1d1d1;border-left:1px solid #d1d1d1}h1.svelte-1bd78nq.svelte-1bd78nq{font-family:"harmony", serif;line-height:119px;letter-spacing:0.015em;color:#3c3c3c}h1.svelte-1bd78nq.svelte-1bd78nq{font-size:75px;line-height:91.35px}@media screen and (min-width: 1280px){h1.svelte-1bd78nq.svelte-1bd78nq{font-size:calc(75px + strip-unit(21px) * ((100vw - 1280px) / strip-unit(640px)));line-height:calc(75px + strip-unit(21px) * 1.618 * ((100vw - 1280px) / strip-unit(640px))- 30px)}}@media screen and (min-width: 1920px){h1.svelte-1bd78nq.svelte-1bd78nq{font-size:96px;line-height:125.328px}}@media only screen and (max-width: 1280px){h1.svelte-1bd78nq.svelte-1bd78nq{font-size:48px;line-height:60px}}@media only screen and (max-width: 720px){h1.svelte-1bd78nq.svelte-1bd78nq{font-size:24px;line-height:30px}}@media only screen and (max-height: 480px){h1.svelte-1bd78nq.svelte-1bd78nq{font-size:24px;line-height:30px}}.noiseBG.svelte-1bd78nq.svelte-1bd78nq{mix-blend-mode:multiply;background-image:url("/noise.png");opacity:0.15;height:100%;width:100%}@media only screen and (max-width: 1280px){.noiseBG.svelte-1bd78nq.svelte-1bd78nq{opacity:0.3}}',
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\n\\timport { gsap } from 'gsap/dist/gsap.js';\\n\\timport { SteppedEase } from 'gsap/dist/gsap.js';\\n\\timport { ScrollTrigger } from 'gsap/dist/ScrollTrigger.js';\\n\\timport { onMount } from 'svelte';\\n\\n\\timport Star from '../svg/star.svelte';\\n\\timport Flower from '../svg/flower.svelte';\\n\\timport Loader from '../components/Loader.svelte';\\n\\timport Footer from '../components/Footer.svelte';\\n\\timport CircleType from '../components/CircleType.svelte';\\n\\timport { projects } from '../Projects/ProjectDetails';\\n\\timport ProjectPreview from '../components/ProjectPreview.svelte';\\n\\timport Ending from '../components/Ending.svelte';\\n\\n\\tlet content = 'hide';\\n\\tlet gridContainer, hero;\\n\\n\\tgsap.registerPlugin(ScrollTrigger);\\n\\n\\tonMount(() => {\\n\\t\\tcontent = 'show';\\n\\t\\tlet q = gsap.utils.selector(gridContainer);\\n\\n\\t\\t//ANIMATION\\n\\t\\tvar staticAnime = gsap.timeline();\\n\\t\\tvar mainAnime = gsap.timeline();\\n\\t\\tgsap.from(hero, {\\n\\t\\t\\topacity: 0,\\n\\t\\t\\tx: -30,\\n\\t\\t\\tduration: 1,\\n\\t\\t\\tdelay: 0.5\\n\\t\\t});\\n\\t\\tgsap.to(q('.noiseBG'), {\\n\\t\\t\\tduration: 0.03,\\n\\t\\t\\trepeat: -1,\\n\\t\\t\\tonRepeat: repeatStatic,\\n\\t\\t\\tease: SteppedEase.config(1)\\n\\t\\t});\\n\\t\\tfunction repeatStatic() {\\n\\t\\t\\tgsap.set(q('.noiseBG'), {\\n\\t\\t\\t\\tbackgroundPosition:\\n\\t\\t\\t\\t\\tMath.floor(Math.random() * 100) + 1 + '% ' + Math.floor(Math.random() * 10) + 1 + '%'\\n\\t\\t\\t});\\n\\t\\t}\\n\\t\\tstaticAnime\\n\\t\\t\\t.from(q('.changePdivTwo'), {\\n\\t\\t\\t\\topacity: 0.5,\\n\\t\\t\\t\\twidth: 0,\\n\\t\\t\\t\\tduration: 1\\n\\t\\t\\t})\\n\\t\\t\\t.from(\\n\\t\\t\\t\\tq('.changePdivOne'),\\n\\t\\t\\t\\t{\\n\\t\\t\\t\\t\\topacity: 0.5,\\n\\t\\t\\t\\t\\theight: 0,\\n\\t\\t\\t\\t\\tduration: 1\\n\\t\\t\\t\\t},\\n\\t\\t\\t\\t'>-0.4'\\n\\t\\t\\t);\\n\\t\\tmainAnime.to(gridContainer, {\\n\\t\\t\\tscrollTrigger: {\\n\\t\\t\\t\\ttrigger: gridContainer,\\n\\t\\t\\t\\tstart: 'end top',\\n\\t\\t\\t\\tscrub: true\\n\\t\\t\\t},\\n\\t\\t\\topacity: 0\\n\\t\\t});\\n\\t});\\n<\/script>\\n\\n<svelte:head>\\n\\t<title>Gautham Krishna - Home</title>\\n</svelte:head>\\n\\n\\n\\t{#if content === 'hide'}\\n\\t\\t<Loader />\\n\\t{/if}\\n\\t<Footer />\\n\\t<CircleType\\n\\t\\ttypeText=\\"| &ensp; PORTFOLIO &ensp; || &ensp; SCROLL DOWN &ensp; || &ensp; MY WORKS &ensp; |\\"\\n\\t/>\\n\\t<div class={content}>\\n\\t\\t<main>\\n\\t\\t\\t<div bind:this={hero} class=\\"hero\\">\\n\\t\\t\\t\\t<h1>Whatever the problem, being part of the solution.</h1>\\n\\t\\t\\t\\t<div>\\n\\t\\t\\t\\t\\t<span>Designer</span>\\n\\t\\t\\t\\t\\t<Star />\\n\\t\\t\\t\\t\\t<span>Developer</span>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\t\\t\\t<div bind:this={gridContainer} class=\\"hero-illu\\">\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t\\t<div class=\\"noiseBG changePdivTwo\\" />\\n\\t\\t\\t\\t<div class=\\"noiseBG changePdivOne\\" />\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t\\t<div />\\n\\t\\t\\t</div>\\n\\t\\t\\t<Flower />\\n\\t\\t</main>\\n\\t\\t<ProjectPreview project={projects[0]} no={1} />\\n\\t\\t<Ending />\\n\\t</div>\\n\\n\\n<style lang=\\"scss\\">main {\\n  display: grid;\\n  grid-template-columns: 1.5fr 1fr;\\n  margin-top: 12vh;\\n  height: 100vh;\\n}\\n@media only screen and (max-width: 1280px) {\\n  main {\\n    margin-top: 100px;\\n    height: 100vh;\\n    grid-template-columns: 1fr;\\n    grid-template-rows: 1.5fr 1fr;\\n  }\\n}\\n@media only screen and (max-width: 720px) {\\n  main {\\n    margin-top: 30px;\\n  }\\n}\\n@media only screen and (max-height: 480px) {\\n  main {\\n    margin-top: 30px;\\n  }\\n}\\nmain .hero {\\n  margin: 8vh 20px 0 120px;\\n  max-width: 1000px;\\n}\\nmain .hero div {\\n  margin-top: 10px;\\n  display: flex;\\n  align-items: center;\\n  font-size: 24px;\\n  color: #505050;\\n  letter-spacing: 0.15em;\\n}\\n@media only screen and (max-width: 1280px) {\\n  main .hero div {\\n    margin-top: 10px;\\n    font-size: 18px;\\n  }\\n}\\n@media only screen and (max-width: 720px) {\\n  main .hero div {\\n    margin-top: 5px;\\n    font-size: 14px;\\n  }\\n}\\n@media only screen and (max-height: 480px) {\\n  main .hero div {\\n    margin-top: 5px;\\n    font-size: 14px;\\n  }\\n}\\n@media only screen and (max-width: 1280px) {\\n  main .hero {\\n    max-width: 500px;\\n    margin: 100px 20px 20px 64px;\\n  }\\n}\\n@media only screen and (max-width: 720px) {\\n  main .hero {\\n    max-width: 250px;\\n    margin: 100px 10px 10px 40px;\\n  }\\n}\\n@media only screen and (max-height: 480px) {\\n  main .hero {\\n    max-width: 250px;\\n    margin: 100px 10px 10px 40px;\\n  }\\n}\\nmain .hero-illu {\\n  position: absolute;\\n  width: 35%;\\n  top: 0;\\n  right: 0;\\n  bottom: 0;\\n  display: grid;\\n  grid-template-columns: 1fr 1fr 1fr;\\n  grid-template-rows: 1fr 2fr 2fr;\\n}\\n@media only screen and (max-width: 1280px) {\\n  main .hero-illu .changePdivOne {\\n    grid-column: 2/3;\\n    grid-row: 2/3;\\n  }\\n}\\n@media only screen and (max-width: 1280px) {\\n  main .hero-illu .changePdivTwo {\\n    grid-column: 3/4;\\n    grid-row: 1/2;\\n  }\\n}\\n@media only screen and (max-width: 1280px) {\\n  main .hero-illu {\\n    opacity: 30%;\\n    top: auto;\\n    bottom: 0;\\n    right: 0;\\n    width: 100%;\\n    height: 40%;\\n    grid-template-columns: 1fr 1fr 1fr;\\n    grid-template-rows: 1fr 1fr;\\n  }\\n}\\nmain .hero-illu div {\\n  border-top: 1px solid #d1d1d1;\\n  border-left: 1px solid #d1d1d1;\\n}\\n\\nh1 {\\n  font-family: \\"harmony\\", serif;\\n  line-height: 119px;\\n  letter-spacing: 0.015em;\\n  color: #3c3c3c;\\n}\\nh1 {\\n  font-size: 75px;\\n  line-height: 91.35px;\\n}\\n@media screen and (min-width: 1280px) {\\n  h1 {\\n    font-size: calc(75px + strip-unit(21px) * ((100vw - 1280px) / strip-unit(640px)));\\n    line-height: calc(75px + strip-unit(21px) * 1.618 * ((100vw - 1280px) / strip-unit(640px))- 30px);\\n  }\\n}\\n@media screen and (min-width: 1920px) {\\n  h1 {\\n    font-size: 96px;\\n    line-height: 125.328px;\\n  }\\n}\\n@media only screen and (max-width: 1280px) {\\n  h1 {\\n    font-size: 48px;\\n    line-height: 60px;\\n  }\\n}\\n@media only screen and (max-width: 720px) {\\n  h1 {\\n    font-size: 24px;\\n    line-height: 30px;\\n  }\\n}\\n@media only screen and (max-height: 480px) {\\n  h1 {\\n    font-size: 24px;\\n    line-height: 30px;\\n  }\\n}\\n\\n.noiseBG {\\n  mix-blend-mode: multiply;\\n  background-image: url(\\"/noise.png\\");\\n  opacity: 0.15;\\n  height: 100%;\\n  width: 100%;\\n}\\n@media only screen and (max-width: 1280px) {\\n  .noiseBG {\\n    opacity: 0.3;\\n  }\\n}</style>\\n"],"names":[],"mappings":"AA+GmB,IAAI,8BAAC,CAAC,AACvB,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,KAAK,CAAC,GAAG,CAChC,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,KAAK,AACf,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,IAAI,8BAAC,CAAC,AACJ,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,KAAK,CACb,qBAAqB,CAAE,GAAG,CAC1B,kBAAkB,CAAE,KAAK,CAAC,GAAG,AAC/B,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,IAAI,8BAAC,CAAC,AACJ,UAAU,CAAE,IAAI,AAClB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,aAAa,KAAK,CAAC,AAAC,CAAC,AAC1C,IAAI,8BAAC,CAAC,AACJ,UAAU,CAAE,IAAI,AAClB,CAAC,AACH,CAAC,AACD,mBAAI,CAAC,KAAK,eAAC,CAAC,AACV,MAAM,CAAE,GAAG,CAAC,IAAI,CAAC,CAAC,CAAC,KAAK,CACxB,SAAS,CAAE,MAAM,AACnB,CAAC,AACD,mBAAI,CAAC,KAAK,CAAC,GAAG,eAAC,CAAC,AACd,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,MAAM,AACxB,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,KAAK,CAAC,GAAG,eAAC,CAAC,AACd,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,IAAI,AACjB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,mBAAI,CAAC,KAAK,CAAC,GAAG,eAAC,CAAC,AACd,UAAU,CAAE,GAAG,CACf,SAAS,CAAE,IAAI,AACjB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,aAAa,KAAK,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,KAAK,CAAC,GAAG,eAAC,CAAC,AACd,UAAU,CAAE,GAAG,CACf,SAAS,CAAE,IAAI,AACjB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,KAAK,eAAC,CAAC,AACV,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,AAC9B,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,mBAAI,CAAC,KAAK,eAAC,CAAC,AACV,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,AAC9B,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,aAAa,KAAK,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,KAAK,eAAC,CAAC,AACV,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,AAC9B,CAAC,AACH,CAAC,AACD,mBAAI,CAAC,UAAU,eAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAClC,kBAAkB,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,AACjC,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,UAAU,CAAC,cAAc,eAAC,CAAC,AAC9B,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,QAAQ,CAAE,CAAC,CAAC,CAAC,AACf,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,UAAU,CAAC,cAAc,eAAC,CAAC,AAC9B,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,QAAQ,CAAE,CAAC,CAAC,CAAC,AACf,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,mBAAI,CAAC,UAAU,eAAC,CAAC,AACf,OAAO,CAAE,GAAG,CACZ,GAAG,CAAE,IAAI,CACT,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,CAAC,CACR,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,qBAAqB,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAClC,kBAAkB,CAAE,GAAG,CAAC,GAAG,AAC7B,CAAC,AACH,CAAC,AACD,mBAAI,CAAC,UAAU,CAAC,GAAG,eAAC,CAAC,AACnB,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC7B,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAChC,CAAC,AAED,EAAE,8BAAC,CAAC,AACF,WAAW,CAAE,SAAS,CAAC,CAAC,KAAK,CAC7B,WAAW,CAAE,KAAK,CAClB,cAAc,CAAE,OAAO,CACvB,KAAK,CAAE,OAAO,AAChB,CAAC,AACD,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,OAAO,AACtB,CAAC,AACD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,WAAW,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,MAAM,CAAC,CAAC,CAAC,CAAC,WAAW,KAAK,CAAC,CAAC,CAAC,CACjF,WAAW,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,WAAW,IAAI,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,MAAM,CAAC,CAAC,CAAC,CAAC,WAAW,KAAK,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,AACnG,CAAC,AACH,CAAC,AACD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AACrC,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,SAAS,AACxB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,aAAa,KAAK,CAAC,AAAC,CAAC,AAC1C,EAAE,8BAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AACnB,CAAC,AACH,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,cAAc,CAAE,QAAQ,CACxB,gBAAgB,CAAE,IAAI,YAAY,CAAC,CACnC,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,AACb,CAAC,AACD,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,QAAQ,8BAAC,CAAC,AACR,OAAO,CAAE,GAAG,AACd,CAAC,AACH,CAAC"}`
};
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `${$$result.title = `<title>Gautham Krishna - Home</title>`, ""}`, ""}
	...
	<div class="${escape(null_to_empty(content)) + " svelte-1bd78nq"}"><main class="${"svelte-1bd78nq"}"><div class="${"hero svelte-1bd78nq"}"${add_attribute("this", hero, 0)}><h1 class="${"svelte-1bd78nq"}">Whatever the problem, being part of the solution.</h1>
				<div class="${"svelte-1bd78nq"}"><span>Designer</span>
					${validate_component(Star, "Star").$$render($$result, {}, {}, {})}
					<span>Developer</span></div></div>
			<div class="${"hero-illu svelte-1bd78nq"}"${add_attribute("this", gridContainer, 0)}><div class="${"svelte-1bd78nq"}"></div>
				<div class="${"svelte-1bd78nq"}"></div>
				<div class="${"svelte-1bd78nq"}"></div>
				<div class="${"svelte-1bd78nq"}"></div>
				<div class="${"svelte-1bd78nq"}"></div>
				<div class="${"noiseBG changePdivTwo svelte-1bd78nq"}"></div>
				<div class="${"noiseBG changePdivOne svelte-1bd78nq"}"></div>
				<div class="${"svelte-1bd78nq"}"></div>
				<div class="${"svelte-1bd78nq"}"></div></div>
