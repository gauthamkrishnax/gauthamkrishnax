...
<svelte:head>
	...
	<meta
		name="description"
		content="Gautham Krishna (Portfolio - About) - developer and designer | Whatever the problem, being part of the solution | Kerala, India. "
	/>
</svelte:head>
...
<style lang="scss">
	...
	h2 {
		font-family: $primary-font;
		@include fluid-font(1280px, 1920px, 48px, 60px);
		line-height: 119px;
